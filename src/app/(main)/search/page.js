...
const page = () => {
    return (
        <div className='2xl:px-[70px] xl:px-16 px-8 2xl:my-36 xl:my-36 py-28'>
            ...
            <div className='2xl:w-1/2 xl:w-1/2 w-full mx-auto'>
                <div className='my-10 space-y-6'>
                    <h2 className='text-2xl  font-semibold text-center border border-gray-200 bg-slate-200 p-4 rounded-xl shadow-xl cursor-pointer'>
