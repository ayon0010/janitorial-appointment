        ...
        <div className='grid 2xl:grid-cols-3 xl:grid-cols-3 grid-cols-1 gap-10 mt-10' data-aos="fade-up">
            <div className="card card-compact py-4 bg-green-50 shadow-xl">
                ...
                <div className="card-body mt-6">
                    ...
                    <p className='text-center font-semibold inter text-black 2xl:text-base xl:text-sm opacity-90 px-4'>Achieve sales conversion rates of 20% to 30%, customized based on your service needs and target areas, maximizing revenue opportunities.</p>
                </div>
            </div>
            <div className="card card-compact bg-green-50 shadow-xl pt-4 pb-10">
                ...
                <div className="card-body mt-6">
                    ...
                    <p className='text-center font-semibold inter text-black 2xl:text-base xl:text-sm opacity-90 px-4'>Our thorough 3-step verification process ensures reliable, premium-quality leads tailored to your specifications across the U.S. and Canada.</p>
                </div>
            </div>
            <div className="card card-compact bg-green-50 shadow-xl py-4">
                ...
                <div className="card-body mt-6">
                    ...
                    <p className='text-center font-semibold inter text-black 2xl:text-base xl:text-sm opacity-90 px-4'>We specialize in securing appointments for cleaning services, connecting you directly with key contacts through targeted telemarketing and social outreach.</p>
                </div>
            </div>
        </div>
    );
