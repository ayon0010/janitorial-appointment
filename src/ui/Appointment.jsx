...
const Appointment = () => {
    ...
    return (
        <div className='relative z-40'>
            <Image src={appointment} width={1150} height={350} sizes="(max-width: 768px) 20vw, 100vw" priority alt='book-an-appointment' className='absolute h-full w-full right-0 left-0 inset-0 z-20' />
