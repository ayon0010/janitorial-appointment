...
const Profiled = () => {
    ...
    return (
        <div className='2xl:mt-14 xl:mt-14 mt-10 relative w-full rounded-xl'>
            <Image src={profileImage} className='w-full h-[192px]' alt='your-info' />
            <Image src={woman} alt='avatar' className='absolute bottom-0 left-10  h-[300px] w-auto' />
            <div className='absolute top-1/2 right-8 transform -translate-y-1/2 2xl:w-fit xl:w-fit w-1/4'>
